...
//#define EXAMPLE_MQTT_SERVER_HOST "60827e69821e4eaab4cd2d6c7a7b681f.s1.eu.hivemq.cloud"
#endif
...
static const struct mqtt_connect_client_info_t mqtt_client_info = {
    ...
    .client_user = "hivemq.webclient.1709216398392",
    .client_pass = "g4x1.0F*2#:qwfoVLOQN",
    .keep_alive  = 100,
    .will_topic  = NULL,
    .will_msg    = NULL,
    .will_qos    = 0,
...
/*!
 * @brief Subscribe to MQTT topics - wrapper for tcpip_callback
 */
static void mqtt_subscribe_topics_wrapper(void *arg)
{
    mqtt_client_t *client = (mqtt_client_t *)arg;
    static const char *topics[] = {"lwip_topic/1", "lwip_other/1"};
    int qos[]                   = {0, 1};
    err_t err;
    int i;

    PRINTF("Starting MQTT subscriptions...\r\n");
...
{
    /* Schedule subscription on tcpip_thread to avoid callback issues */
    err_t err = tcpip_callback(mqtt_subscribe_topics_wrapper, client);
    if (err != ERR_OK)
    {
        PRINTF("Failed to schedule MQTT subscriptions: %d\r\n", err);
    }
}
...
static void connect_to_mqtt(void *ctx)
{
    ...
    err = mqtt_client_connect(mqtt_client, &mqtt_addr, EXAMPLE_MQTT_SERVER_PORT, mqtt_connection_cb,
...
static void publish_message(void *ctx)
{
    ...
    static const char *message = "HELLO FROM MIMXRT1060-EVKC";
 ...
 */
void mqtt_freertos_run_thread(struct netif_new *netif)
{
    LOCK_TCPIP_CORE();
